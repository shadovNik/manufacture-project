...
import "./OperatorReportDetails.css";
...
const OperatorReportDetails = () => {
    ...
    return (
        <>
            <OperatorHeader />
            <main className="operator-report-details-main">
                <div className="operator-report-details-content">
...
export default OperatorReportDetails;